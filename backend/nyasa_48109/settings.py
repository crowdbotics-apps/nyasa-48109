"""
Django settings for nyasa_48109 project.
...
WSGI_APPLICATION = 'nyasa_48109.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nyasa_48109 API",
    "DESCRIPTION": "API documentation for nyasa_48109 App",
    "VERSION": "v1",
}
